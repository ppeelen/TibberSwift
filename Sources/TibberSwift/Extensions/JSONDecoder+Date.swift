...
extension JSONDecoder {
    ...
    /// Usage:
    ///
    ///      decoder.dateDecodingStrategyFormatters = [.standard, .json]
    ///
    /// The decoder will now be able to decode two DateFormats, the 'standard' one and the 'json'
    ///
...
extension DateFormatter {
    ...
    /// Sets the json DateFormat ISO-8601 format
